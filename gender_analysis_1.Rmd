...
```{r}
m1 <-'SSB_sqrt_scale ~ IND_scale + EXP_scale + AVA_log10_scale + MON_scale + AUT_sqrt_scale + MOD_log10_scale + parent_gender  + RACE_ETH + child_SEX + parent_ED + FOOD_SEC + iEO_log10'
```
